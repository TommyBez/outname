...
*Run agents that don't fund someone else's data center at [app.outna.me/login](https://app.outna.me/login). Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license. No $190B capex required.*
