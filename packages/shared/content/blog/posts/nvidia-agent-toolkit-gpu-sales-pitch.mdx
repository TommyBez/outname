...
**Outname is building the platform where agents ship with sandboxes, not afterthoughts.** Identity, scoped tools, persistent memory, scheduled runs — deployed in one click. Fork it, inspect it, or just use the hosted product. [Create an account →](https://app.outna.me/login)
