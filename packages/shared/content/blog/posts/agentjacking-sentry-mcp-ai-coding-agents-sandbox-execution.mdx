...
*Want agents that run inside sandboxed execution — with file-based identity, scoped tools, and scheduled heartbeats — from day one? Join the waitlist at [outna.me/waitlist](https://outna.me/waitlist). Outname is open source (MIT): [github.com/TommyBez/outname](https://github.com/TommyBez/outname).*
