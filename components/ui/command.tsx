  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        className={cn(
          'flex h-10 min-w-0 flex-1 rounded-md bg-transparent py-3 text-sm outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
