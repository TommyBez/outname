...
export const SandboxTabsTrigger = ({
  ...
  <TabsTrigger
    className={cn(
      "rounded-none border-0 border-transparent border-b px-4 py-2 font-medium text-muted-foreground text-sm transition-colors data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none",
      className
    )}
    {...props}
  />
