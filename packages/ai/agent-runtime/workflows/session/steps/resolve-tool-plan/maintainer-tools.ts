...
import type { MaintainerTool, Reconnect } from '@outname/ai/tools/catalog/types'
import {
...
import { toolSandboxBuilds, toolSandboxSnapshots } from '@outname/db/schema'
...
async function manifestHashStep(input: {
  ...
  'use step'
  const { manifestHash } = await import('@outname/ai/tools/sandboxes')
