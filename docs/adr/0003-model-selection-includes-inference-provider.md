...
usage metadata through Vercel AI Gateway, LLM Gateway, or OpenRouter, so agents
and usage records must persist the inference provider alongside the model id.
