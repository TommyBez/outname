...
*Build agents that don't need a chat window at [outna.me/waitlist](https://outna.me/waitlist). The codebase is open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license. No superapp required.*
