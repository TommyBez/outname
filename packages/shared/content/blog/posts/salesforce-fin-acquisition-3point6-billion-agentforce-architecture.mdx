...
*Run agents that don't require a CRM to be useful at [app.outna.me/login](https://app.outna.me/login). File-based identity. Sandboxed execution. Model-agnostic. Open source. Agent-native — from the first line of code.*
