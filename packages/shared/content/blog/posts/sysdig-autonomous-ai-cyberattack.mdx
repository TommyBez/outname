...
**Outname is building the platform for agents that can't accidentally steal your database.** Sandboxed execution, enumerated tool access, identity-scoped filesystems — deployed in one click. Fork it, inspect it, or just use the hosted product. [Join the waitlist →](https://outna.me/waitlist)
