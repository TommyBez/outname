...
**Outname gives every agent an identity card, a persona, and persistent memory — as files, not as a cloud billing line item.** Free. Portable. Human-readable. No API quota. No per-memory cost. [Create an account →](https://app.outna.me/login)
