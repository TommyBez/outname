...
*Run agents that keep working — without the walled garden — at [app.outna.me/login](https://app.outna.me/login). Identity as files. Memory as files. Model-agnostic. Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license.*
