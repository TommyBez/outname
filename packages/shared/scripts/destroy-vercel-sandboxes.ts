...
Examples:
  SANDBOX_TEAM_ID=... SANDBOX_PROJECT_ID=... SANDBOX_ACCESS_TOKEN=... pnpm vercel:sandboxes:destroy-all
  SANDBOX_TEAM_ID=... SANDBOX_PROJECT_ID=... SANDBOX_ACCESS_TOKEN=... pnpm vercel:sandboxes:destroy-all --execute
`)
}
