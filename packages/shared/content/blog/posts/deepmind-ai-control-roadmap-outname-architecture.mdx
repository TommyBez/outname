...
*Want agents that run with sandboxed execution, file-based identity, and defense-in-depth — the architecture DeepMind just prescribed — from day one? Join the waitlist at [outna.me/waitlist](https://outna.me/waitlist). Outname is open source (MIT): [github.com/TommyBez/outname](https://github.com/TommyBez/outname).*