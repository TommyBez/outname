...
- **Vercel Workflow, Sandbox, and AI Gateway** are Vercel platform services. Agent sessions, the system sandbox, and heartbeat loops require a Vercel deployment to work fully. Locally, the UI and CRUD operations work but autonomous agent execution does not.
