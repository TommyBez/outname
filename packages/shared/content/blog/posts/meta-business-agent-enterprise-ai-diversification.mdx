...
*Build agents with their own identity, memory, and sandboxed execution at [app.outna.me/login](https://app.outna.me/login). Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license. Agents that keep working — not advertising platforms that learned to schedule meetings.*
