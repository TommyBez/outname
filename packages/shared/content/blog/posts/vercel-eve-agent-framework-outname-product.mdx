...
*Outname is the hosted platform for personal AI agents with readable memory, schedules, tools, and sandboxed execution. No terminal required. Create an account at [app.outna.me/login](https://app.outna.me/login). Inspect the code at [github.com/TommyBez/outname](https://github.com/TommyBez/outname).*
