...
*Build agents with identity, memory, and sandboxed execution at [app.outna.me/login](https://app.outna.me/login). Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license. When AI commoditizes, the agent is what remains.*
