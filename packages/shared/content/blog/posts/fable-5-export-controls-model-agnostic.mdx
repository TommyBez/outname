...
*Run agents that survive the next Commerce Department letter at [app.outna.me/login](https://app.outna.me/login). Model-agnostic architecture. File-based memory. Sandboxed execution. Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license.*
