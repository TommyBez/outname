...
export function PrimaryLink({
  ...
  return (
    <Link
      className="group ease inline-flex min-h-14 w-full items-center justify-center gap-4 border border-border bg-foreground py-2 pr-2 pl-6 font-bold text-background text-xs tracking-normal transition-[transform,background-color,color,border-color] duration-150 hover:border-brand hover:bg-brand hover:text-brand-foreground active:scale-[0.98] sm:w-auto"
      href={href}
    >
      {children}
      <span
