...
*Build agents you can trust at [app.outna.me/login](https://app.outna.me/login). Identity files. Memory files. Sandboxed execution. Open source at [github.com/TommyBez/outname](https://github.com/TommyBez/outname). MIT license. No financial account access — by design.*
