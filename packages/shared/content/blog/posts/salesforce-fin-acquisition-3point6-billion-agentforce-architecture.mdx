...
Story one: Agentforce is a rocket ship. $1.2 billion in ARR in Q1 FY27, up 205% year-over-year. 29,000 deals. 2.4 billion agentic work units. Enterprise AI agents are no longer a bet — they are a booked-and-billed reality.
...
Salesforce now owns two agent platforms. One is deeply integrated with its CRM. The other is deeply integrated with the customer conversation. The press release says they will "complement" each other. That's corporate language for: we haven't figured out how to merge them yet.
